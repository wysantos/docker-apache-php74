#  LAMP stack built with Docker Compose from apache witch php-7.4 + mariadb 10.3 + redis + pphpmyadmin
...
```shell
git clone https://github.com/wysantos/docker-apache-php74.git
cd docker-apache-php74/
cp sample.env .env
